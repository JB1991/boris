...
export class EditFormularComponent implements OnInit, ComponentCanDeactivate {

  private wsUnsavedChanges = false;

  pin: string;
  model: any;

  css = {
    root: 'sv_main sv_bootstrap_css card m-2',
    ...
    completedPage: '',
    navigation: {
      complete: 'sv_complete_btn btn-success',
      prev: 'sv_prev_btn btn-primary',
      next: 'sv_next_btn btn-primary',
      start: 'sv_start_btn btn-success'
    },
  ...
  constructor(private route: ActivatedRoute, private service: FormularService) { }
