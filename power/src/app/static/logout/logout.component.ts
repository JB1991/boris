...
export class LogoutComponent implements OnInit {
    ...
    constructor(
        ...
        this.meta.updateTag({ name: 'description', content: $localize`Ausloggen vom Immobilienmarkt.NI Portal` });
        this.meta.updateTag({ name: 'keywords', content: $localize`Immobilienmarkt, Niedersachsen, Wertermittlung, Logout` });
    }
