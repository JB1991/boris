...
export class ImmobilienComponent implements OnDestroy, AfterViewInit {
     ...
     * @param selectType
     */
    public setMapOptions(selectType: any = 'multiple'): void {
     ...
     * @param ec
     */
    public onChartChartInit(ec: any): void {
     ...
     * @param end
     */
    public onChangeQuartal(start: number, end: number): void {
        if (start !== null) {
     ...
     * @param name
     */
    public onClickDrawRoot(name: any): void {
        this.updateMapSelect();
        this.updateChart();
    }
